...
class DrQA(object):
    ...
    def __init__(
        ...
        """
        from QASystem.inference import Inference
    ...
    def QANetInference(self, contexts, queries, top_n=1):
        return self.inference.test(contexts, queries)
    ...
    def process_batch(self, queries, candidates=None, top_n=1, n_docs=5,
        ...
        logger.info('............ Inference with QANet .............')
        passages =  []
        quers = []
        for doc in examples:
            passages.append(' '.join(doc['document']))
            quers.append(queries[0])
        print(self.QANetInference(passages, quers))
