...
from QASystem.layers import initializer, regularizer, residual_block, highway, conv, mask_logits, trilinear, total_params, optimized_trilinear_for_attention
...
class Model(object):
    ...
    def forward(self):
        ...
        with tf.variable_scope("Output_Layer"):
            ...
            self.probs = [tf.reduce_max(outer, axis=2),tf.reduce_max(outer, axis=1)]
